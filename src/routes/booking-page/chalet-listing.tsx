...
const ChaletListings = ({ chalets, isLoading }: ChaletListingsProps) => {
  ...
  const displayedChalets = chalets?.slice(0, 3) || [];
    ...
    <div className="space-y-12">
            ...
            <CardHeader className="space-y-1">
              <div className="flex justify-between items-start">
                ...
                <span className="text-green-600 font-semibold">
                  KES{" "}
                  {Number(chalet.price).toLocaleString("en-US", {
      ...
      <div className="relative rounded-xl overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url(https://www.heritage-eastafrica.com/greatriftvalleylodgeandgolfresort/media/great-rift-valley-lodge-and-golf-resort-banners20201009_1721462.jpg)",
          }}
        />
        ...
        <div className="relative py-12 px-6 md:px-12">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/90 mb-6">
              Experience luxury at Great Rift Valley Lodge. Book your stay for 3
              nights or more and enjoy a 20% discount on our best available
              rates.
            </p>
            <Button
              size="lg"
              className="bg-white text-[#27534c] hover:bg-white/90"
            >
              View Special Offers
            </Button>
          </div>
